...
public class CustomResourcePackProvider implements ResourcePackProvider {
    ...
    public void register (Consumer<ResourcePackProfile> consumer, ResourcePackProfile.Factory factory) {
        ...
        ResourcePackProfile profile = ResourcePackProfile.of(packName, true, packSupplier, factory, ResourcePackProfile.InsertionPosition.TOP, ResourcePackSource.PACK_SOURCE_NONE);
        if (profile != null) {
