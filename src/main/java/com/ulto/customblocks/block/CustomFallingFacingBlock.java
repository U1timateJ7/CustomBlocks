...
public class CustomFallingFacingBlock extends CustomFacingBlock {
    public CustomFallingFacingBlock(Settings settings, boolean _fromPlayerFacing, List<JsonObject> drops, List<JsonObject> shape, JsonObject block) {
