...
public class CustomFallingStairBlock extends CustomStairBlock implements LandingBlock {
    public CustomFallingStairBlock(Settings settings, JsonObject block) {
