...
public class CustomPillarBlock extends PillarBlock {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (block.has("on_use")) Events.playBlockActionEvent(state, pos, world, MiscUtils.mapOf("entity", player, "hand", hand, "blockhitresult", hit), block.getAsJsonObject("on_use"));
