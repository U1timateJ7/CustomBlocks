...
public class CustomFallingFenceBlock extends CustomFenceBlock implements LandingBlock {
    public CustomFallingFenceBlock(Settings settings, JsonObject block) {
