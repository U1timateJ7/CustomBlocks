...
public class CustomWaterloggedFallingFacingBlock extends CustomWaterloggedFacingBlock implements LandingBlock {
    public CustomWaterloggedFallingFacingBlock(Settings settings, boolean _fromPlayerFacing, List<JsonObject> shape, JsonObject block) {
