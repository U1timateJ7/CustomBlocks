...
public class CustomWaterloggedFallingHorizontalFacingBlock extends CustomWaterloggedHorizontalFacingBlock implements LandingBlock {
    public CustomWaterloggedFallingHorizontalFacingBlock(Settings settings, boolean _fromPlayerFacing, List<JsonObject> shape, JsonObject block) {
