...
public class CustomMiningToolItem extends DiggerItem {
    ...
    public CustomMiningToolItem(float attackDamage, float attackSpeed, Tier material, Tag<Block> effectiveBlocks, Properties settings, JsonArray tooltip, JsonObject item) {
