...
public class CustomIllagerEntity extends AbstractIllager {
    private JsonObject entity = new JsonObject();

    public CustomIllagerEntity(EntityType<? extends AbstractIllager> entityType, Level world, JsonObject entity) {
    ...
    public SoundEvent getCelebrateSound() {
        return entity.has("celebrating_sound") ? ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation(entity.get("celebrating_sound").getAsString())) : SoundEvents.VINDICATOR_CELEBRATE;
    }
