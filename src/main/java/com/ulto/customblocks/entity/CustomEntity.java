...
public class CustomEntity extends PathAwareEntity {
    ...
    protected void mobTick() {
        if (entity.has("on_tick")) Events.playEntityEvent(this, MiscUtils.mapOf(), entity.getAsJsonObject("on_tick"));
    }

    @Override
    public void onDeath(DamageSource source) {
        if (entity.has("on_death")) Events.playEntityEvent(this, MiscUtils.mapOf(), entity.getAsJsonObject("on_death"));
    }

    @Override
    protected ActionResult interactMob(PlayerEntity player, Hand hand) {
        if (entity.has("on_use")) return Events.playEntityEvent(this, MiscUtils.mapOf("sourceentity", player), entity.getAsJsonObject("on_use"));
        return super.interactMob(player, hand);
    }

    @Override
    protected void onBlockCollision(BlockState state) {
        if (entity.has("on_use")) Events.playEntityEvent(this, MiscUtils.mapOf("blockstate", state), entity.getAsJsonObject("on_use"));
    }
}
