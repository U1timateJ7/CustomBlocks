...
public class CustomWaterEntity extends WaterCreatureEntity {
    private JsonObject entity = new JsonObject();

    public CustomWaterEntity(EntityType<? extends WaterCreatureEntity> entityType, World world, JsonObject entity) {
