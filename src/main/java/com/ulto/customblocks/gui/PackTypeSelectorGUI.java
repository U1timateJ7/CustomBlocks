...
public class PackTypeSelectorGUI extends LightweightGuiDescription {
    public PackTypeSelectorGUI() {
        ...
        WLabel topLabel = new WLabel(Text.translatable("gui.pack_type_selector.label.top"));
        root.add(topLabel, 108, 10);
        WButton blockItemPackButton = new WButton(Text.translatable("gui.pack_type_selector.button.block_item_pack"));
